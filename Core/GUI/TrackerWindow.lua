...
local function Show(self)
	...
	if not self.frame then -- First call -> Create new instance via AceGUI and configure it
		...
		border:SetBackdropColor(1,0,0,0) -- This will shrine through if there's a spacer > 0 between elements, so it should be transparent
		local r, g, b = AM.Utils.HexToRGB(activeStyle.frameColours.Window.border, 255)
		border:SetBackdropBorderColor(r, g, b, activeStyle.frameColours.Window.borderAlpha) -- This should be updated dynamically (TODO)
